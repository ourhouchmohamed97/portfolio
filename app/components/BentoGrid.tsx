...
import { BellIcon, HandshakeIcon, LaptopIcon, LayersIcon, } from "lucide-react";
...
let notifications = [
  {
    ...
    description: "Project phase delivered",
    time: "15m ago",
    icon: "✅",
    color: "#00C9A7",
  },
  ...
  {
    name: "Feature Added",
    description: "New component ready",
    time: "5m ago",
    icon: "💡",
    color: "#FF3D71",
  },
  {
    name: "Update Logged",
    description: "Project progress tracked",
    time: "2m ago",
    icon: "📢",
    color: "#1E86FF",
  },
...
export function GlobeDemo() {
  return (
    <div className="relative flex h-[500px] w-full max-w-lg flex-col items-center justify-between overflow-hidden px-10 pt-8 pb-40">
      ...
      <h2 className="w-full animate-fadeInUp text-balance text-center font-instrument-serif leading-tight opacity-90 dark:text-zinc-100">
        <span className="font-instrument-serif lg:text-5xl md:text-base z-10">Work from anywhere, reach <span className="text-blue-500">everywhere.</span></span>
      </h2>
    </div>
        <Globe />
      <div className="pointer-events-none z-0 absolute inset-0 h-full bg-[radial-gradient(circle_at_50%_200%,rgba(0,0,0,0.2),rgba(255,255,255,0))]" />
    </div>
  )
}
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center gap-1 mx-auto">
      <h2 className="w-full animate-fadeInUp text-balance text-center font-instrument-serif leading-tight opacity-90 dark:text-zinc-100">
        ...
        <br />
        <SparklesText className="font-instrument lg:text-5xl md:text-base">on <span className="text-blue-500">your</span> next project</SparklesText>
      </h2>
    </div>
  );
}
...
const files = [
  {
    ...
    body: "Scalable apps with clean data flow and state management.",
  },
  {
    name: "Realtime Features",
    body: "Live updates and syncing to keep clients aligned.",
  },
  {
    name: "Security Setup",
    body: "Secure login, roles, and session management.",
  },
  {
    name: "Responsive UI",
    body: "Reusable, polished layouts for all screen sizes.",
  },
  {
    name: "API Integration",
    body: "Reliable API communication for smooth experiences.",
  },
  {
    name: "Notification System",
    body: "Event-driven alerts to keep users informed.",
  },
  {
    name: "Performance Optimization",
    body: "Fast load times and optimized rendering.",
  },
  {
    name: "Dashboard Interfaces",
    body: "Interactive dashboards for insights and metrics.",
  },
  {
    name: "Maps & Location Features",
    body: "Geolocation tools and real-time map interfaces.",
  },
  {
    name: "Design System",
    body: "Consistent typography and component standards.",
  },
  {
    name: "CI/CD",
    body: "Automated builds and reliable deployments.",
  },
  {
    name: "Payment Integration",
    body: "Secure checkout and subscription management.",
  },
];
...
const features = [
  {
    Icon: HandshakeIcon,
    name: "Collaboration",
    description: "Build the project side-by-side with me, shaping every detail together as your vision comes to life.",
  ...
  },
  {
    ...
    description: "Know what’s happening as I work on your project.",
    href: "#",
    cta: "See Updates",
    className: "col-span-2 row-span-2 col-start-4 row-start-1 h-full max-h-[700px]", // tall right box
    background: (
      <AnimatedListDemo
  ...
  {
    Icon: () => null,
    className: "col-span-2 row-span-1 h-[300px] flex justify-center align-center", // tall left box
    background: <Collaboration />
  },
  {
    Icon: LayersIcon,
    name: "Inside Scoop",
    description: "Currently building a SaaS application with real-time features, tracking tools, and a fully customized design system.",
    href: "#",
    cta: "View Recent Work",
    className: "row-span-2 col-start-2 row-start-4 h-[300px]", // bottom wide box
    background: (
      <Marquee
        pauseOnHover
