        ...
        <div className="w-full h-screen flex mx-auto max-w-7xl flex-col items-center justify-center dark:bg-black py-pagebuilder">
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <h1 className="w-full text-balance text-center font-instrument-serif text-4xl md:text-5xl lg:text-6xl text-zinc-700 leading-tight opacity-90 dark:text-zinc-100 font-instrument">
              Get in<span style={{ color: "#432dd7" }}>Touch</span>
            </h1>
          </div>
          <section className="w-full max-w-4xl mx-auto px-4 py-12">
            <div className="bg-white dark:bg-black border-gray-200 dark:border-white/10 rounded-2xl shadow-2xl border w-full max-w-4xl min-h-[600px] md:min-h-[800px] py-20 md:py-32">
              {/* Decorative Bar */}
              ...
              {/* Tabs */}
              <div className="flex justify-center gap-12 px-6 mb-6">
                <button
                ...
                {activeTab === "quick" && (
                  <div className="space-y-4">
                    ...
                    <div className="text-center py-4">
                      ...
                      <h3 className="text-gray-900 dark:text-white text-2xl font-semibold mb-1">
                        Email
                      </h3>
                      ...
                      <div className="bg-gray-50 dark:bg-white/5 border-gray-200 dark:border-white/10 rounded-lg border px-4 py-4 max-w-sm mx-auto">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <a
                            href="mailto:ourhouchmohamed97@gmail.com"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-gray-50 dark:bg-white/5 border-gray-300 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-400 border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={4}
                        className="w-full bg-gray-50 dark:bg-white/5 border-gray-300 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-400 border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            ...
            {showCopyNotification && (
              <div className="fixed top-8 left-1/2 -translate-x-1/2 bg-blue-600 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-12 animate-in fade-in slide-in-from-top duration-300 z-50">
                <svg
                  className="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
            ...
            {showFormNotification && (
              <div className="fixed top-8 left-1/2 -translate-x-1/2 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 animate-in fade-in slide-in-from-top duration-300 z-50">
                <svg
                  className="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
